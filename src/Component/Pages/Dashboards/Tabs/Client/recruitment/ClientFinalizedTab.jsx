...
import {
  ...
  FiDownload, FiFileText, FiExternalLink
} from 'react-icons/fi';
                      ...
                      <td className="px-6 py-4 whitespace-nowrap text-left">
                        <div className="flex flex-col items-start">
                          <span className="text-sm font-bold text-[#1A1A2E]">
                            {c.joiningDate ? new Date(c.joiningDate).toLocaleDateString('en-GB', { day: 'numeric', month: 'short', year: 'numeric' }).toUpperCase() : 'TBD'}
                          </span>
                          <span className="text-[9px] font-bold text-[#9B9BAD] uppercase tracking-wider mt-0.5">
                            {c.joiningStatus === 'Rescheduled' ? 'Rescheduled' : 'Joining Date'}
                          </span>
                        </div>
                      </td>
                      <td className="px-6 py-4 whitespace-nowrap text-center">
                        <div className="flex flex-col items-center gap-1">
                          <span className={`px-4 py-1.5 rounded-full text-[10px] font-bold uppercase tracking-widest border ${
                            (c.joiningStatus || 'Pending') === 'Joined'
                              ? 'bg-emerald-50 text-emerald-700 border-emerald-100'
                              : (c.joiningStatus || 'Pending') === 'Not Joined'
                              ? 'bg-rose-50 text-rose-700 border-rose-100'
                              : (c.joiningStatus || 'Pending') === 'Rescheduled'
                              ? 'bg-amber-50 text-amber-700 border-amber-100'
                              : 'bg-blue-50 text-[#1B4DA0] border-blue-100'
                          }`}>
                            {c.joiningStatus || 'Pending'}
                          </span>
                          <span className="text-[9px] font-bold text-[#9B9BAD] uppercase tracking-wider">
                            Stage: {c.stage}
                          </span>
                        </div>
                      </td>
            ...
            <>
              ...
              >
                ...
                <div className="flex-1 overflow-y-auto px-10 py-8 custom-scrollbar space-y-10">
                  ...
                  {(selectedCandidate.stage === 'Joined' || selectedCandidate.stage === 'Offer Sent') && (selectedCandidate.joiningDate || selectedCandidate.joiningStatus) && (
