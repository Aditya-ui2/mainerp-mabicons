...
import { BASE_URL, submitDailyReport, getMyReports, uploadMISAttachment } from '../../../service/api';
...
const ReportCard = ({ report, index, onClick }) => {
  const metrics = [
    ...
    { label: 'Leads', value: report.profilesVisited, icon: Eye, color: '#8b5cf6', bg: '#ede9fe' },
    { label: 'Meetings', value: report.profilesShared, icon: Calendar, color: '#0891b2', bg: '#ecfeff' },
    { label: 'Proposals', value: report.candidatesContacted, icon: FileText, color: '#10b981', bg: '#d1fae5' },
    { label: 'Deals', value: report.interviewsArranged, icon: CheckCircle, color: '#f59e0b', bg: '#fef3c7' },
  ];
        ...
        <div className="overflow-x-auto custom-scrollbar">
          <div className="min-w-[1000px]">
            ...
            <div className="grid grid-cols-[2fr_100px_100px_100px_120px_120px_80px] gap-4 px-8 py-4 border-b border-[#F4F3EF] bg-transparent">
              ...
              {["Calls", "Leads", "Meetings", "Proposals", "Deals"].map((h, i) => (
                  ...
                  <div>
                    ...
                    <div className="grid grid-cols-2 gap-4">
                      {[
                        ...
                        { label: 'Leads Generated', value: selectedReport.profilesVisited, icon: Eye },
                        { label: 'Meetings Scheduled', value: selectedReport.profilesShared, icon: Calendar },
                        { label: 'Proposals Sent', value: selectedReport.candidatesContacted, icon: FileText },
                        { label: 'Deals Closed', value: selectedReport.interviewsArranged, icon: CheckCircle },
                    ...
                    <form onSubmit={handleSubmit} className="px-6 py-5 space-y-6">
                      ...
                      <div>
                        ...
                        <div className="grid grid-cols-2 sm:grid-cols-3 gap-3">
                          <MetricInput icon={Phone} label="Calls Made" sublabel="Total calls made" color="#3b82f6" bg="#dbeafe" name="callsCount" value={form.callsCount} onChange={handleFieldChange} />
                          <MetricInput icon={Eye} label="Leads Generated" sublabel="New leads today" color="#8b5cf6" bg="#ede9fe" name="profilesVisited" value={form.profilesVisited} onChange={handleFieldChange} />
                          <MetricInput icon={Calendar} label="Meetings" sublabel="Scheduled today" color="#0891b2" bg="#ecfeff" name="profilesShared" value={form.profilesShared} onChange={handleFieldChange} />
                          <MetricInput icon={FileText} label="Proposals" sublabel="Proposals sent" color="#10b981" bg="#d1fae5" name="candidatesContacted" value={form.candidatesContacted} onChange={handleFieldChange} />
                          <MetricInput icon={CheckCircle} label="Deals Closed" sublabel="Closed today" color="#f59e0b" bg="#fef3c7" name="interviewsArranged" value={form.interviewsArranged} onChange={handleFieldChange} />
                        </div>
                      </div>
