                  ...
                  {filteredClients.map((client) => {
                    ...
                    return (
                      ...
                      >
                        ...
                        <td className="px-8 py-4 text-left">
                          <div
                            className={`px-3 py-2 rounded-xl text-[11px] font-black uppercase tracking-widest inline-flex items-center gap-2
                          ...
                          >
                            <div
                              className={`w-1.5 h-1.5 rounded-full ${client.status === 'Active'
                                ? 'bg-[#10B981]'
                                : 'bg-slate-400'
                                }`}
                            />
                        ...
                        <td className="px-8 py-4 text-left">
                          <div className="flex flex-col">
                            <span className="text-[13px] font-black text-[#1A1A2E]">
                              {client.feeAmount ? "₹" + Number(client.feeAmount).toLocaleString("en-IN") : "₹0"}
                            </span>
                        ...
                        <td className="px-8 py-4 text-left">
                          <div className="flex flex-col">
                            <span className="text-[13px] font-black text-red-500">
                              {client.account?.totalOutstanding ? "₹" + Number(client.account.totalOutstanding).toLocaleString("en-IN") : "₹0"}
                            </span>
        ...
        <AnimatePresence>
          {selectedIds.length > 0 && (
            ...
            >
              ...
              <div className="flex items-center gap-4">
                {clients.filter(c => selectedIds.includes(c._id || c.id)).some(c => (c.status || '').toLowerCase() !== 'active') && (
                  <button
                ...
                <button
                  ...
                  className="flex items-center gap-2 group px-4 py-2 rounded-2xl transition-all hover:bg-white/5 active:scale-95 text-red-400 hover:text-red-300"
                >
                  <FiTrash size={16} />
                  ...
                  <div className="bg-[#FAFAF8] rounded-[32px] border border-[#F4F3EF] p-8 space-y-10 shadow-sm">
                    ...
                    <div className="space-y-6">
                      ...
                      <div className="grid grid-cols-2 gap-x-8 gap-y-6">
                        ...
                        />
                        <InfoItem
                          label="Fee Amount (Monthly)"
                          value={isEditingInDetail ? editableClient?.feeAmount : selectedClientDetail.feeAmount}
                          isEditing={isEditingInDetail}
                          type="number"
                          onChange={(val) => setEditableClient({ ...editableClient, feeAmount: val })}
                        />
                      </div>
                    </div>
            ...
            <React.Fragment>
              ...
              <div className="fixed inset-0 flex items-center justify-center z-[400001] p-4">
                ...
                >
                  ...
                  <h3 className="text-2xl font-bold text-[#1A1A2E] mb-2 font-syne">Delete Selected Clients?</h3>
                  <p className="text-sm text-[#6B6B7E] mb-8 leading-relaxed">
                    Are you sure you want to delete <span className="font-bold text-[#1A1A2E]">{selectedIds.length}</span> clients? This action cannot be undone.
                  </p>
