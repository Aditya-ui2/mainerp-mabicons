...
const ClientOnboardingForm = ({ isOpen, onClose, onComplete, initialData = null }) => {
  ...
  const initialFormState = {
    companyName: '', cin: '', pan: '', clientType: '', industry: '', website: '', yearIncorporation: '',
  ...
  const handleSubmit = async () => {
    ...
    try {
      ...
      if (isEdit) {
        await editClient(formData.clientId, formData);
  ...
  const SummarySection = ({ title, data }) => (
    <div className="bg-[#F8FAFF] rounded-[24px] p-6 border border-[#F4F3EF] space-y-4">
      <h4 className="text-[12px] font-black text-[#1B4DA0] uppercase tracking-widest flex items-center gap-2">
        <FiCheckCircle className="text-emerald-500" /> {title}
      </h4>
              ...
              <AnimatePresence mode="wait">
                ...
                {step === 2 && (
                  ...
                  >
                    <div>
                      ...
                      <div className="grid grid-cols-1 md:grid-cols-2 gap-x-8 gap-y-8">
                        <SelectField label="Agreement Type" name="agreementType" value={formData.agreementType} onChange={handleInputChange} options={['MSA', 'SLA', 'Custom Contract']} required />
                    ...
                    <div>
                      ...
                      <div className="grid grid-cols-1 md:grid-cols-2 gap-x-8 gap-y-8">
                        ...
                        <InputField label="Attendance System" name="attendanceSystem" value={formData.attendanceSystem} onChange={handleInputChange} placeholder="e.g. Biometric" />
                ...
                {step === 3 && (
                  ...
                  >
                    ...
                    <div className="p-8 bg-emerald-50/50 border border-emerald-100 rounded-[32px] flex items-start gap-5">
                      <div className="w-6 h-6 rounded bg-emerald-100 text-emerald-600 flex items-center justify-center shrink-0 mt-1">
                        <input
                          type="checkbox"
                      ...
                      <div>
                        <h5 className="text-[15px] font-bold text-emerald-900">Confirm Onboarding Details</h5>
              ...
              <div className="flex gap-4">
                ...
                {step < 3 ? (
                  ...
                  <button
                    ...
                    disabled={submitting}
                    className="flex items-center gap-3 px-12 py-4 bg-emerald-600 text-white font-black uppercase tracking-widest text-[12px] rounded-[20px] hover:bg-emerald-700 transition-all shadow-xl shadow-emerald-500/20 active:scale-95 disabled:opacity-50"
                  >
