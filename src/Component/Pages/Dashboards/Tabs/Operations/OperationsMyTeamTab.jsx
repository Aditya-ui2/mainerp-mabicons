...
const OperationsMyTeamTab = ({ department = 'HR Operations' }) => {
  ...
  return (
    <div className="space-y-8 animate-in fade-in duration-500">
      ...
      {/* Filter Bar - Same as Recruitment Head */}
      ...
      <div className="bg-white rounded-[32px] shadow-sm border border-[#F4F3EF] overflow-hidden relative">
        <div className="overflow-x-auto min-h-[300px]">
          <table className="w-full text-left border-collapse">
            <thead>
              <tr className="border-b border-[#F4F3EF] text-left bg-transparent">
                <th className="px-8 py-4 w-12 text-left">
                  <input
                    type="checkbox"
                ...
                <th className="px-8 py-4 text-left text-[11px] font-bold text-[#94a3b8] uppercase tracking-widest w-[30%]">Member</th>
                <th className="px-8 py-4 text-left text-[11px] font-bold text-[#94a3b8] uppercase tracking-widest w-[20%]">Department</th>
                <th className="px-8 py-4 text-left text-[11px] font-bold text-[#94a3b8] uppercase tracking-widest w-[30%]">Email Address</th>
                <th className="px-8 py-4 text-left text-[11px] font-bold text-[#94a3b8] uppercase tracking-widest w-32">Connect</th>
                <th className="px-8 py-4 text-left text-[11px] font-bold text-[#94a3b8] uppercase tracking-widest w-12">Actions</th>
              </tr>
            </thead>
...
export default OperationsMyTeamTab;
