                  ...
                  return (
                    ...
                    >
                      ...
                      <div className="relative z-10 flex-shrink-0 hidden sm:block">
                        <div className={`w-10 h-10 rounded-xl flex items-center justify-center font-bold text-sm shadow-lg group-hover:scale-110 transition-transform duration-500 ${
...
export default OperationsMISReportsTab;
