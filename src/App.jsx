...
import AccountsDashboard from './Component/Pages/Dashboards/AccountsDashboard';
import SalesDashboard from './Component/Pages/Dashboards/SalesAdminDashboard';
import TechDashboard from './Component/Pages/Dashboards/TechDashboard';
...
import SalesKamDashboard from './Component/Pages/Dashboards/SalesKamDashboard';
  ...
  return (
    <>
      ...
      <Route path='/sales-dashboard' element={
        <ProtectedRoute allowedRoles={['sales', 'admin', 'superadmin']}>
          <SalesDashboard />
        </ProtectedRoute>
      } />
      <Route path='/sales-kam-dashboard' element={
          <ProtectedRoute allowedRoles={['salesKam', 'admin', 'superadmin']}>
            <SalesKamDashboard />
          </ProtectedRoute>
        }
      />
      ...
      <Route path='/tech-dashboard' element={
        <ProtectedRoute allowedRoles={['tech', 'admin', 'superadmin']}>
          <TechDashboard />
        </ProtectedRoute>
      } />
